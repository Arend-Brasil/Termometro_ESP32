...
void handle_config_page() {
  ...
  page.reserve(3900);
  page += F("<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'>");
  page += F("<title>Config avancada</title><style>body{font-family:Arial,sans-serif;margin:20px;max-width:620px;background:#101418;color:#f6f7f9}.card{border:1px solid #33404a;padding:14px;margin:12px 0;background:#182028}label{display:block;margin:12px 0;padding:10px;border:1px solid #33404a}input[type=number],input[type=text]{box-sizing:border-box;width:100%;padding:10px;font-size:16px;background:#f6f7f9;color:#101418}button{margin-top:12px;padding:12px 16px;font-size:16px}code{background:#26313a;padding:2px 5px}a{color:#7fd7ff}.warn{color:#f4c542}</style></head><body>");
